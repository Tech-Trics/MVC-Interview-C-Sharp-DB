...
namespace MVC_Interview_C_Sharp.ExampleClasses
{
    public interface ICollectionExample
    {
        ...
        /// <returns></returns>
        int SumOfCustomersByCompanyName(string companyName, List<Customer> customers);
        ...
        /// <param name="customers"></param>
        /// <returns></returns>
        List<Customer> CustomersWithMiddleNames(List<Customer> customers);
        ...
        /// <param name="customers"></param>
        /// <returns></returns>
        List<Customer> SortListByCustomerName(List<Customer> customers);
        ...
        /// <returns></returns>
        string GetCustomerNamesAndRemoveDuplicateLetters(char letterToRemove);
        ...
        /// <returns></returns>
        int  GetCustomerNamesAndCountOccuranceOfLetter(char letterToCount, string name);
        ...
        /// <param name="customers"></param>
        /// <returns></returns>
        List<string> DistinctListOfCustomerNames(List<Customer> customers);
        ...
        /// <param name="customers"></param>
        /// <returns></returns>
        List<Customer> ReverseCustomerNames(List<Customer> customers);
